...
//import twitter from '../assets/Twitter.svg';//this would work
...
export default function AudioPlayer({music}) {
  ...
  const [icons, setIcons] = React.useState({
    volume: null,
    noVolume: null,
    play: "<svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'><path fill-rule='evenodd' clip-rule='evenodd' d='M6 20H8.43757V19.2H9.65827V18.4H10.877V17.6H12.0958V16.8H13.3146V16H14.5333V15.2H15.7501V14.4H16.9689V13.6H18.1896V12.8H19.0021V11.2H18.1896V10.4H16.9689V9.6H15.7501V8.8H14.5333V8H13.3146V7.2H12.0958V6.4H10.877V5.6H9.65827V4.8H8.43757V4H6V20Z' fill='#333333'/><rect width='2' height='2' transform='matrix(1 0 0 -1 11 13)' fill='#333333'/></svg>",
    pause: null
  });
